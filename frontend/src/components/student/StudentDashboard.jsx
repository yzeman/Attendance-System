...
const MarkAttendance = () => {
  ...
  const fetchCourses = async () => {
    try {
      ...
      if (enrolledIds.length > 0) {
        ...
        // Auto-select first UNMARKED course if available
  ...
  // Separate courses into marked and unmarked
            ...
            <Card className="p-3 shadow-lg">
              ...
              {courses.length === 0 ? (
                ...
                <>
                  ...
                  {/* Marked Courses Section (Collapsed) */}
                  ...
                  {getSelectedCourseDetails() && unmarkedCourses.length > 0 && (
                    <div className="p-2 bg-light rounded mb-3" style={{ border: '2px solid #28a745' }}>
                      <div className="d-flex justify-content-between align-items-center">
                        <div>
                  ...
                  {unmarkedCourses.length === 0 && courses.length > 0 && (
                    <div className="mt-3 text-center">
                      ...
                      <p className="text-success fw-bold">You've marked all your courses today!</p>
